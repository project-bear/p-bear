...
import info.bear.model.Student;
...
public class JdbcTemplateToolTest extends AbstractJUnit4SpringContextTests{
	...
	public void testList() throws IOException, SQLException {
		...
		List<Employee> es = jtt.findList("select * from employee where age < ? order by id desc", new Object[]{30}, Employee.class);
	...
	public void testCount() throws IOException, SQLException {
		...
		long total = jtt.findCount("select count(1) from employee", null);
